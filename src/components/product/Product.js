...
if (isWidthUp("sm", props.width)) {
  // Use the modified Carousel component with a specified height
  photos = <Carousel photos={product.photos} url={product.url} height="300px" />;
} else {
  // Use the modified MobileCarousel component with a specified height
  photos = (
    <MobileCarousel photos={product.photos} url={product.url} height="200px" />
  );
}
